                    ...
                    <div class="mdl-grid">
                        <div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--8-col">
                            <div class="mdl-card__title">
                                <div class="mdl-card__title-text mdl-color-text--primary">
                                    我的课程
                                </div>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <div class="mdl-card__title-text mdl-color-text--primary">
                                    <ul class="mdl-list" id="course-list">

                                    </ul>
                                </div>
                            </div>
                            <div class="mdl-card__actions mdl-card--border">
                                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="/courses">
                                    查看所有课程
                                </a>
                            </div>
                        </div>
